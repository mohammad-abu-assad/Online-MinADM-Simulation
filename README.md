...
│   └── reports/
└── tests/
    ├── test_online_minadm.py
    └── test_optimal_solution.py
```
...
- **gui/**: Contains all GUI-related code.
  - **main_window.py**: Sets up the main window and integrates different tabs.
  - **simulation_tab.py**: Handles the algorithm simulation interface.
  - **comparison_tab.py**: Manages the comparison between online and optimal solutions.
  - **analysis_tab.py**: Provides tools for analyzing results.
  - **assets/**: Contains icons and stylesheets for the GUI.
- **algorithms/**: Implementation of the ONLINE-MINADM algorithm and the optimal solution.
  - **online_minadm.py**: The online algorithm implementation.
  - **optimal_solution.py**: Computes the optimal offline solution.
  - **utils.py**: Utility functions used across algorithms.
- **data/**: Default data files.
  - **traffic_demands.csv**: Sample traffic demands.
  - **network_config.json**: Network configuration files.
- **analysis/**: Contains scripts and data for analysis.
  - **analyzer.py**: Performs data analysis.
  - **plots.py**: Generates graphs and charts.
